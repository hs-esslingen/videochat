...
import { TransportOptions, RtpParameters, MediaKind, RtpCapabilities } from "mediasoup-client/lib/types";
...
export class ApiService {
  ...
  public getMedia(): Promise<TransportOptions> {
  ...
  public addConsumer(id, rtpCapabilities, producerId): Promise<{ id: string; rtpParameters: RtpParameters }> {
    return this.http
